...
- All 17 OEM IDs with strict typing
...
Complete configuration for all 17 Australian OEMs:
...
Complete brand identity notes for all 17 OEMs including:
...
│   ├── registry.ts       # 17 OEM configurations
