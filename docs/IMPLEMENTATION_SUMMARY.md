...
- All 16 OEM IDs with strict typing
...
Complete configuration for all 16 Australian OEMs:
...
Complete brand identity notes for all 16 OEMs including:
...
│   ├── registry.ts       # 16 OEM configurations
