...
declare global {
  ...
  const tailwindRules: typeof import('../composables/capture-tailwind-rules').tailwindRules
  ...
  const useClipboard: typeof import('../composables/use-clipboard').useClipboard
