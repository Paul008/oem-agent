...
import { Activity, AlertTriangle, Brain, Loader2, TrendingUp } from 'lucide-vue-next'
    ...
    <div v-if="!loading" class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
      ...
      <div class="border rounded-lg p-5">
        ...
        <p v-else class="text-sm text-muted-foreground">
          No brand tokens recorded yet. Run an extraction to populate.
        </p>
      </div>
      ...
      <div class="border rounded-lg p-5">
        ...
        <div class="space-y-2 text-sm">
          ...
          <p v-if="!hasProfile" class="text-muted-foreground">
            No extraction hints yet.
          </p>
        </div>
      </div>
        ...
        <table class="w-full text-sm">
          ...
          <tbody>
            ...
            <tr v-for="run in runs" :key="run.id" class="border-b last:border-0 hover:bg-muted/30">
              ...
              <td class="px-4 py-2">
                <span
                  class="px-2 py-0.5 rounded text-xs" :class="{
