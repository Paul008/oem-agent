      ...
      <div class="space-y-3">
        ...
        <div>
          <div class="flex items-center justify-between mb-1">
            ...
            <button class="text-xs text-primary hover:underline" @click="addArrayItem('cards', createSectionFeatureCardItem())">
              <Plus class="size-3 inline mr-0.5" />Add
            </button>
          </div>
    ...
    <template v-else-if="sectionType === 'image-showcase'">
      <div class="space-y-3">
        ...
        <div>
          <div class="flex items-center justify-between mb-1">
            <label class="text-xs text-muted-foreground">Images ({{ section.images?.length ?? 0 }})</label>
            <button class="text-xs text-primary hover:underline" @click="addArrayItem('images', createSectionShowcaseImageItem())">
              <Plus class="size-3 inline mr-0.5" />Add
            </button>
          </div>
          <div v-for="(img, i) in (section.images || [])" :key="i" class="border rounded p-2 mb-1.5 space-y-1.5">
