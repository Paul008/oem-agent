...
onMounted(async () => {
  try { previewOems.value = await fetchOems() }
  catch {}
})
    ...
    <div class="col-span-3 space-y-5 overflow-y-auto max-h-[600px] pr-2">
      ...
      <section v-if="pattern === 'hero'" class="space-y-3">
        ...
        <div class="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            >
              <option v-for="s in ['xl', '2xl', '3xl', '4xl', '5xl', '6xl']" :key="s" :value="s">
                {{ s }}
              </option>
            </select>
          </div>
          ...
          <div>
            ...
            >
              <option v-for="w in ['light', 'normal', 'medium', 'semibold', 'bold', 'extrabold']" :key="w" :value="w">
                {{ w }}
              </option>
            </select>
          </div>
          ...
          <div>
            ...
            >
              <option v-for="p in ['top-left', 'top-center', 'bottom-left', 'bottom-center', 'center']" :key="p" :value="p">
                {{ p }}
              </option>
            </select>
          </div>
          ...
          <div>
            ...
            >
              <option v-for="h in ['50vh', '75vh', '100vh']" :key="h" :value="h">
                {{ h }}
              </option>
            </select>
          </div>
      ...
      <section class="space-y-3">
        ...
        <div class="grid grid-cols-3 gap-3">
          <div>
            ...
            >
              <option v-for="s in ['sm', 'base', 'lg', 'xl', '2xl', '3xl', '4xl']" :key="s" :value="s">
                {{ s }}
              </option>
            </select>
          </div>
          <div>
            ...
            >
              <option v-for="w in ['normal', 'medium', 'semibold', 'bold', 'extrabold']" :key="w" :value="w">
                {{ w }}
              </option>
            </select>
          </div>
          <div>
            ...
            >
              <option v-for="s in ['xs', 'sm', 'base', 'lg']" :key="s" :value="s">
                {{ s }}
              </option>
            </select>
          </div>
      ...
      <section class="space-y-2">
        ...
        <div v-if="showRawJson">
          ...
          />
          <p v-if="!rawJsonValid" class="text-xs text-destructive mt-1">
            Invalid JSON
          </p>
        </div>
      </section>
