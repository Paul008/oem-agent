...
export const SECTION_DEFAULTS: Record<PageSectionType, () => Record<string, any>> = {
  ...
  'testimonial': () => ({ title: 'What Our Customers Say', testimonials: [{ quote: '', author: '', role: '', avatar_url: '', rating: 5 }], layout: 'carousel', animation: 'fade-in' }),
  ...
  'stats': () => ({ title: '', stats: [{ value: '', label: '', unit: '', icon_url: '' }], layout: 'row', background: '', animation: 'count-up' }),
