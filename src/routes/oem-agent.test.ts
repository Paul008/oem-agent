  ...
  it.each([
    {
      ...
      body: { url: 'https://example.test/tunland', oem_id: 'foton-au' },
    },
    { method: 'POST', path: '/admin/generate-page/foton-au/tunland' },
    { method: 'POST', path: '/admin/clone-page/foton-au/tunland' },
    { method: 'POST', path: '/admin/structure-page/foton-au/tunland' },
    { method: 'PUT', path: '/admin/update-sections/foton-au/tunland' },
    { method: 'PUT', path: '/admin/update-clone/foton-au/tunland' },
    { method: 'POST', path: '/admin/import-legacy/foton-au/tunland' },
    { method: 'POST', path: '/admin/scrape-oem/foton-au/tunland' },
    { method: 'POST', path: '/admin/scrape-gac/foton-au/tunland' },
    { method: 'POST', path: '/admin/upload-media/foton-au/tunland' },
    { method: 'POST', path: '/admin/regenerate-section/foton-au/tunland' },
    { method: 'PUT', path: '/admin/screenshot/foton-au/tunland' },
    { method: 'PUT', path: '/admin/dealer-overrides/foton-au/tunland' },
    {
      method: 'POST',
      path: '/admin/page-templates/apply',
      body: { template_id: 'basic-landing', oem_id: 'foton-au', model_slug: 'tunland' },
    },
    { method: 'POST', path: '/admin/adaptive-pipeline/foton-au/tunland' },
    { method: 'POST', path: '/admin/adaptive-pipeline/nissan-au/ariya' },
    { method: 'POST', path: '/admin/create-custom-page/foton-au/warranty' },
    { method: 'POST', path: '/admin/create-subpage/foton-au/tunland/specs' },
    { method: 'DELETE', path: '/admin/delete-subpage/foton-au/tunland/specs' },
    { method: 'DELETE', path: '/admin/delete-custom-page/foton-au/warranty' },
