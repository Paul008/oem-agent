...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  // Pass OPENCLAW_DEV_MODE explicitly, or fall back to DEV_MODE
  if (env.OPENCLAW_DEV_MODE) envVars.OPENCLAW_DEV_MODE = env.OPENCLAW_DEV_MODE;
  else if (env.DEV_MODE) envVars.OPENCLAW_DEV_MODE = env.DEV_MODE;
